...
def test_zero_capacity():
    ...
    result = algo.run(data, capacity=0)
...
def test_single_item_fit():
    ...
    result = algo.run(data, capacity=2)
...
def test_optimal_selection():
    ...
    result = algo.run(data, capacity=5)
...
def test_output_format():
    ...
    result = algo.run(data, capacity=1)
